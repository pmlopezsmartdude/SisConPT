   ...
   <asp:Table ID="Table1" runat="server" Width="653px" Height="30px" Font-Names="Century Gothic" Font-Size="x-Small"  HorizontalAlign="Center" >
     <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
       <asp:TableCell Width="30">
             ...
             <asp:TableCell>
                <asp:TextBox   runat="server" ID="txtDescarte"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
             ...
             <asp:Label ID="lblCATII" runat="server" Text="% Exportable Comercial CAT II" Width="50" Height="20"></asp:Label>
                ...
                <asp:TextBox  runat="server" ID="txtCATII"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
            </asp:TableCell><asp:TableCell Width="30">
             ...
             <asp:Label ID="lblCATIII" runat="server" Text="% Exportable Comercial CAT III" Width="50" Height="20"></asp:Label>
                ...
                <asp:TextBox  runat="server" ID="txtCATIII"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
   ...
   <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            <asp:TableCell>
               <asp:Label ID="lblrango1" runat="server" Text="1" Width="30" Height="20"></asp:Label>
                ...
                <asp:TextBox  runat="server" ID="txt3_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt3_porc_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt8_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox   runat="server" ID="txt8_porc_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt21_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt21_porc_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt18_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt18_porc_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt25_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt25_porc_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt19_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt19_porc_1"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
               ...
               <asp:Label ID="Label16" runat="server" Text="2" Width="30" Height="20"></asp:Label>
                ...
                <asp:TextBox  runat="server" ID="txt3_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt3_porc_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt8_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt8_porc_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt21_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt21_porc_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt18_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt18_porc_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt25_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt25_porc_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt19_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                ...
                <asp:TextBox  runat="server" ID="txt19_porc_2"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
      ...
      <asp:TableCell Width="30">
             <asp:Label ID="Label13" runat="server" Text="KILOS LOTE" Width="50" Height="20"></asp:Label>
                ...
                <asp:TextBox  runat="server" ID="KilosLote"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
             ...
             <asp:Label ID="Label14" runat="server" Text="N° TOTES" Width="50" Height="20"></asp:Label>
                ...
                <asp:TextBox  runat="server" ID="NTotes"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
             ...
             <asp:Label ID="Label15" runat="server" Text="% EXP" Width="50" Height="20"></asp:Label>
                ...
                <asp:TextBox  runat="server" ID="porc_exp"  Width="30" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
