...
<fieldset>
   ...
   <asp:TableCell Width="30">
            ...
            <asp:TableCell Width="60">
             ...
             </asp:TableCell></asp:TableRow></asp:Table></fieldset> <asp:Panel ID="Panel1" runat="server">
         ...
         <asp:UpdatePanel ID="upEditOrder" runat="server" >
            <ContentTemplate>   
                 <div id="popupcontainer" style="width:660px">
                                                   <fieldset>
        <legend>RESUMEN</legend><asp:Table ID="Table2" runat="server" Width="653px" Height="30px" 
            ...
            <asp:TableCell>
             ...
             <asp:Label ID="lbl_hasta" runat="server" Width="80" Height="20" Font-Size="Small" Font-Names="Century Gothic"></asp:Label>
                    </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow16" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            <asp:TableCell>
             ...
             <asp:Label ID="lbl_condicion" runat="server" Width="50" Height="20" Font-Size="Small" Font-Names="Century Gothic"></asp:Label>
                    </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow22" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            
            <asp:TableCell>
                 <asp:Label ID="Label8" runat="server" Height="20" Font-Bold="true" Font-Size="Small">Productor : </asp:Label>
            </asp:TableCell><asp:TableCell>
             <asp:Label ID="lbl_productor" runat="server" Width="50" Height="20"  Font-Size="Small" Font-Names="Century Gothic"></asp:Label>
                 </asp:TableCell></asp:TableRow></asp:Table><fieldset>

        <legend>DEFECTOS</legend><asp:Table ID="Table1" runat="server" Width="653px" Height="30px" 
                         Font-Names="Century Gothic" Font-Size="x-Small" HorizontalAlign="Center"  >
...
<asp:TableRow ID="TableRow12" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow1" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow></asp:Table></fieldset> <fieldset>
        <legend>SOLIDOS SOLUBLES</legend><asp:GridView ID="gv_solubles_datos" runat="server" CellPadding="3" ForeColor="Black" 
                            GridLines="Vertical" AllowPaging="True" AutoGenerateColumns="False"  
         ...
         <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
            <ContentTemplate>   
                 <div id="Div1" style="width:660px">
                                                   <fieldset>
        <legend>RESUMEN</legend><asp:Table ID="Table3" runat="server" Width="653px" Height="30px" 
                         Font-Names="Century Gothic" Font-Size="x-Small" HorizontalAlign="Center"  >
   ...
   <asp:TableRow ID="TableRow15" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            <asp:TableCell>
             ...
             <asp:Label ID="lbl_cajas_t" runat="server" Width="50" Height="20"  Font-Size="Small" Font-Names="Century Gothic"></asp:Label>
                 </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow17" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            <asp:TableCell>
             ...
             <asp:Label ID="lbl_condicion_t" runat="server" Width="50" Height="20" Font-Size="Small" Font-Names="Century Gothic"></asp:Label>
                 ...
                 <asp:Label ID="lbl_tit_productor" runat="server" Height="20" Font-Bold="true" Font-Size="Small"></asp:Label>
            </asp:TableCell><asp:TableCell>
             <asp:Label ID="lbl_productor_t" runat="server" Width="50" Height="20" Font-Size="Small" Font-Names="Century Gothic"></asp:Label>
        ...
        <legend>DEFECTOS</legend><asp:Table ID="Table4" runat="server" Width="653px" Height="30px" 
                         Font-Names="Century Gothic" Font-Size="x-Small" HorizontalAlign="Center"  >
...
<asp:TableRow ID="TableRow18" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow19" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow20" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow21" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow4_t" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow5_t" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow6_t" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow7_t" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow8_t" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow9_t" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow10_t" runat="server" HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
            ...
            </asp:TableCell></asp:TableRow></asp:Table></fieldset> <center> <asp:Button ID="btnClose_todos" runat="server" Text="Cerrar" 
                                                CssClass="button" onclick="btnClose_Click" CausesValidation="false" />
