        ...
        <asp:Table ID="Aplicaciones" runat="server" BorderColor="Black" 
            ...
            <asp:TableRow ID="TableRow1" runat="server" BorderColor="Black" BorderStyle="Solid" HorizontalAlign="Center" VerticalAlign="Middle">
                <asp:TableCell ID="TableCell1" runat="server" BorderColor="Black" BorderStyle="Solid">
                    <asp:Button ID="btn_075_resumen" runat="server" onclick="Btn_resumen_075" Text="Exportar Csv" Font-Size="X-Small" Font-Names="Century Gothic" />
                </asp:TableCell>
                ...
                <asp:TableCell ID="TableCell3" runat="server" BorderColor="Black" BorderStyle="Solid">
                    <asp:Button ID="Button3" runat="server" onclick="Btn_cons_proc" Text="CC-PAC-075 por Proceso" Enabled="True" Font-Names="Century Gothic" Font-Size="X-Small" /></asp:TableCell>
                <asp:TableCell ID="TableCell4" runat="server" BorderColor="Black" BorderStyle="Solid">
                    <asp:Button ID="Button4" runat="server" Text="CC-PAC-05 por Código de caja" Enabled="False" Font-Names="Century Gothic" Font-Size="X-Small" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
